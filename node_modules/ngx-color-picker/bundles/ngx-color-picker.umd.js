(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ngx-color-picker', ['@angular/core','@angular/common','exports', '@angular/core', '@angular/common'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.common,global['ngx-color-picker'] = {}, global.ng.core, global.ng.common));
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ColorPickerService, [{
    ...
    var ColorPickerComponent = /** @class */ (function () {
        ...
        __decorate([
            core.ViewChild('dialogPopup', { static: true })
        ], ColorPickerComponent.prototype, "dialogElement", void 0);
        __decorate([
            core.ViewChild('hueSlider', { static: true })
        ], ColorPickerComponent.prototype, "hueSlider", void 0);
        __decorate([
            core.ViewChild('alphaSlider', { static: true })
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ColorPickerComponent, [{
    ...
    var ColorPickerDirective = /** @class */ (function () {
        function ColorPickerDirective(injector, cfr, appRef, vcRef, elRef, _service) {
            ...
            this.cpCmykColorChange = new core.EventEmitter(true);
        ...
        ColorPickerDirective.prototype.openDialog = function () {
            if (!this.dialogCreated) {
                ...
                if (this.cpUseRootViewContainer && this.cpDialogDisplay !== 'inline') {
                    ...
                    var appInstance = this.injector.get(classOfRootComponent, core.Injector.NULL);
                    if (appInstance !== core.Injector.NULL) {
...
ColorPickerModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function ColorPickerModule_Factory(t) { return new (t || ColorPickerModule)(); }, providers: [ColorPickerService], imports: [[common.CommonModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(ColorPickerModule, { declarations: [ColorPickerComponent, ColorPickerDirective, TextDirective, SliderDirective], imports: [ɵngcc1.CommonModule], exports: [ColorPickerDirective] }); })();
